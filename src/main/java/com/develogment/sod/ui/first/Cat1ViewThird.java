...
@Route(value = "third", layout = Cat1MainContainer.class)
public class Cat1ViewThird extends VerticalLayout
{
	public Cat1ViewThird()
	{
		super();
		this.initUI();
	}
	...
	private void initUI()
	{
		...
		this.lblContent.setText("[your example items]");
